...
(wikipedia en "Kawa (Scheme implementation)")
...
(release
 ...
 (source-archive
  (url "ftp://ftp.gnu.org/pub/gnu/kawa/kawa-3.1.1.tar.gz")
  (hash sha256 "8c9a50cd6b100154c901bd190b3acd2fb8353f33622c4a2ce8fa392a7f09e019")))
